...
The daemon is intentionally low-energy: by default it wakes once per minute, checks stored active jobs, reads Codex rate-limit state when a waiting job is due, and resumes unfinished work after quota reset.
